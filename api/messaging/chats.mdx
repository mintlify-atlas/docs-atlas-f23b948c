...
sidebarTitle: "Chats"
description: "Create new chats between users, retrieve a chat by ID, list all chats for a user, and look up the shared chat ID between two users using the CalenderyBack chat API."
---
