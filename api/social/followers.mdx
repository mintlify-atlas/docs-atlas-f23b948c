---
title: "Followers and Following API Endpoints — CalenderyBack"
sidebarTitle: "Followers"
description: "Follow or unfollow users and list a user's followers or following with name-based filtering using the CalenderyBack followers API."
---
