---
title: "CalenderyBack: Social Calendar API Backend"
sidebarTitle: "Introduction"
description: "CalenderyBack is a Spring Boot REST and WebSocket API server for a social calendar app — publications, messaging, social graph, and user management in one service."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Architecture Concepts" icon="sitemap" href="/introduction#architecture-overview">
